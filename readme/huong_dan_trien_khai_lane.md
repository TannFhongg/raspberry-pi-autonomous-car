...
### Thông số thực tế:
- **Lane width**: **25cm ±2cm** (khoảng cách 2 vạch kẻ - ĐÃ ĐO)
- **Robot width**: 15cm
...
# Đo 25cm (±2cm) thực tế = 457 pixels trên ảnh ✅
LANE_WIDTH_PIXELS = 457  # ✅ CALIBRATED VALUE
```
...
```
CALIBRATION RESULT:
  Lane Width (Real):  25 cm       ← Thực tế track
  Lane Width (Pixel): 457 px      ← ✅ CALIBRATED VALUE
